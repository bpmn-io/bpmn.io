...
Read through the [full changelog](https://github.com/bpmn-io/bpmn-js/blob/master/CHANGELOG.md#300) to learn about all issues that were addressed with `bpmn-js@3` as well as breaking changes that may require your action during upgrade.
