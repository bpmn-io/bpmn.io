...
Our first release in 2018 adds a new mode that allows you to sketch simple, well layout BPMN diagrams in seconds rather than minutes. Say hello to element auto placement:
